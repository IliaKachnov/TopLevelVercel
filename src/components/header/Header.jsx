      ...
      <header className='header'>
        <div className='header__wrapper'>
          ...
          <ul className='header__links-wrapper'>
            <Link to={results.header.items[0].url}><li className='header__link'><p>{results.header.items[0].text}</p></li></Link>
            <Link to={results.header.items[1].url}><li className='header__link'><p>{results.header.items[1].text}</p></li></Link>
            <Link to={results.header.items[2].url}><li className='header__link'><p>{results.header.items[2].text}</p></li></Link>
            <Link to={results.header.items[3].url}><li className='header__link'><p>{results.header.items[3].text}</p></li></Link>
            <li className={`header__link ${activeDropdown ? 'active' : ""}`} onClick={() => setActiveDropdown(!activeDropdown)}>
              <p>{results.header.items[4].text}</p>
              ...
              <div className='header__link-dropdown'>
                <Link to={results.header.items[4].subitems[0].url}><p>{results.header.items[4].subitems[0].name}</p></Link>
                <Link to={results.header.items[4].subitems[1].url}><p>{results.header.items[4].subitems[1].name}</p></Link>
              </div>
            </li>
            <Link to={results.header.items[5].url}><li className='header__link'><p>{results.header.items[5].text}</p></li></Link>
          </ul>
          <div className='header__phone-wrapper'>
            <p className='header__phone'>{results.header.phone}</p>
