  ...
  return (
    ...
    <section className='contact'>
      <div className='contact__wrapper'>
        <div className='contact__crumb-wrapper'>
          <span>Main</span>
          <span>Contacts</span>
        </div>
        <div className='contact__container'> 
          <div className='contact__text-wrapper'>
            <h2>Contact Us</h2>
            <p>Phone</p>
            {results && <p>{results.contacts[1].text}</p>}
            <p>Email</p>
            {results && <p>{results.contacts[2].text}</p>}
            <p>Address</p>
            {results && <p>{results.contacts[0].text}</p>}
            <p>Follow Us</p>
            <div className='contact__social-wrapper'>
              <Link to={results.contacts.social.whatsapp}>
              ...
              <Link to={results.contacts.social.telegram}>
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                  <rect width="40" height="40" rx="20" fill="#1A187D"/>
              ...
              <Link to={results.contacts.social.instagram}>
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                  <rect width="40" height="40" rx="20" fill="#1A187D"/>
