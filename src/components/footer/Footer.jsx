        ...
        <div className="footer__wrapper">
          <div className="footer__items">
            <div className='footer__logo-wrapper'>
              <img src={logoFooter} alt="Top Level" />
            </div>
            <div className='footer__item-wrapper'>
              <div className='footer__item'>
                <Link to='/'><h4 className='footer__title'>Car List</h4></Link>
                <Link to='/'><p className='footer__link'>Most Popular</p></Link>
                <Link to='/'><p className='footer__link'>Suv</p></Link>
                <Link to='/'><p className='footer__link'>Cabriolet</p></Link>
                <Link to='/'><p className='footer__link'>Sedans</p></Link>
              </div>
              <div className='footer__item'>
                <h4 className='footer__title'>For Сustomer</h4>
                <Link to='/'><p className='footer__link'>About Us</p></Link>
                <Link to='/'><p className='footer__link'>Partnership</p></Link>
                <Link to='/'><p className='footer__link'>Contacts</p></Link>
                <Link to='/'><p className='footer__link'>Export & Import</p></Link>
                <Link to='/'><p className='footer__link'>Rent-to-own</p></Link>
                <Link to='/'><p className='footer__privacy-mobile'>Privacy Policy</p></Link>
              </div>
            </div>
            <div className="footer__item">
              <h4 className='footer__title'>Contacts</h4>
              <p className='footer__address'>24 4th St - Al Quoz - Al Quoz Industrial Area 3 - Dubai - Street 4 - Warehouse 26</p>
              <p className="footer__phone">(093) 433-88-88</p>
              <h5 className='footer__follow'>Follow Us</h5>
          ...
          <div className='footer__privacy-wrapper'>
            ...
            <p className='footer__rights'>2023 © Top Level Cars. All rights reserved</p>
            <img className='footer__logo-mobile' src={logoFooter} alt="Top Level" />
          </div>
        </div>
      </footer>
    </>
